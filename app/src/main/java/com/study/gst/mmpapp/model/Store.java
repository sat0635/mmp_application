...
public class Store {
    ...
    public Store(int id, String gpsx, String gpsy, String larg_cate, String mid_cate, String small_cate, String name, String imagename, String image, String distnace) {
